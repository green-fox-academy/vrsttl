  ...
  try {
    ...
    if (matchContent !== null) {
      ...
      matchContentArray.forEach(element => {
        ...
        if ((individualPlays[0] && individualPlays[1] && individualPlays[2]) ||
          (individualPlays[3] && individualPlays[4] && individualPlays[5]) ||
          (individualPlays[6] && individualPlays[7] && individualPlays[8]) ||
          (individualPlays[0] && individualPlays[3] && individualPlays[6]) ||
          (individualPlays[1] && individualPlays[4] && individualPlays[7]) ||
          (individualPlays[2] && individualPlays[5] && individualPlays[8]) ||
          (individualPlays[0] && individualPlays[4] && individualPlays[8]) ||
          (individualPlays[2] && individualPlays[4] && individualPlays[6]) === 'X') {
          winnerStatus = 'X wins'
        }
        else if ((individualPlays[0] && individualPlays[1] && individualPlays[2]) ||
          (individualPlays[3] && individualPlays[4] && individualPlays[5]) ||
          (individualPlays[6] && individualPlays[7] && individualPlays[8]) ||
          (individualPlays[0] && individualPlays[3] && individualPlays[6]) ||
          (individualPlays[1] && individualPlays[4] && individualPlays[7]) ||
